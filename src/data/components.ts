...
export const ADVANCEMENTS: AdvancementDefinition[] = [
  ...
  { id: 'rendezvous', name: 'Rendezvous', description: 'Dock and separate spacecraft.', outcomeCount: 5, researchCost: 10 },
  { id: 'reentry', name: 'Re-entry', description: 'Enter atmosphere without burning up capsules.', outcomeCount: 5, researchCost: 10 },
  { id: 'landing', name: 'Landing', description: 'Land where parachutes are ineffective.', outcomeCount: 5, researchCost: 10 },
  { id: 'lifeSupport', name: 'Life Support', description: 'Keep astronauts alive between years.', outcomeCount: 5, researchCost: 10 },
  { id: 'surveying', name: 'Surveying', description: 'Survey unexplored locations from orbit.', outcomeCount: 3, researchCost: 10 },
];
...
export const COMPONENT_DEFINITIONS: ComponentDefinition[] = [
  ...
  { id: 'saturn', name: 'Saturn', type: 'rocket', class: 'red', mass: 20, thrust: 200, cost: 20, seats: 0, requiredAdvancement: 'saturn' },
